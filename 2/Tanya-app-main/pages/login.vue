...
<template>
    ...
    <meta name="google-signin-client_id" content="1006870554827-sgofe1fj6gdjmqq8ir1ga1nf5ivba604.apps.googleusercontent.com">
        <section class="bg-gray-50 dark:bg-gray-900 body">
...
function onSuccess(googleUser) {
  ...
  function signInWithGoogle() {
    gapi.load('auth2', function() {
      gapi.auth2.init({
        client_id: '1006870554827-sgofe1fj6gdjmqq8ir1ga1nf5ivba604.apps.googleusercontent.com'
      }).then(function() {
        const auth2 = gapi.auth2.getAuthInstance();
        auth2.signIn().then(function(googleUser) {
          const id_token = googleUser.getAuthResponse().id_token;
          // Send the `id_token` to your server for verification
          // You can also access user information like `googleUser.getBasicProfile()`
        });
      });
    });
  }
