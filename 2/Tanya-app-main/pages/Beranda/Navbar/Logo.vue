<template>
    <div class="flex">
            <li>
                <div class="mr-3 pr-3">
                    <NuxtLink href="#" to="/beranda" class="block mt-1 text-white  bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 " aria-current="page">
