        ...
        <div class="flex flex-row justify-between ml-20 mr-20 flex-none pt-20">
          <div class="flex container w-3/5">
            ...
            <div class="font-medium ml-5 w-full relative">
              ...
              <div>
                <a href="#" class="font-light text-gray-400 hover:underline">0 Pengikut</a>
                <a href="#" class="font-light text-gray-400 hover:underline">0 Mengikuti</a>
              </div>
            </div>
          </div>
          ...
          <div class="flex container w-2/5">
            <div>
              ...
              <div class="flex-none mt-5">
                <a href="" class="text-base mt-2 flex hover:underline text-blue-500 gap-2"><img src="" alt="icon pekerjaan" class="w-5 h-5 mr-1 mt-0.5">Tambahkan Kredensial Pekerjaan</a>
                <a href="" class="text-base mt-2 flex hover:underline text-blue-500 gap-2"><img src="" alt="icon pekerjaan" class="w-5 h-5 mr-1 mt-0.5">Tambahkan Kredensial Pendidikan</a>
                <a href="" class="text-base mt-2 flex hover:underline text-blue-500 gap-2"><img src="" alt="icon pekerjaan" class="w-5 h-5 mr-1 mt-0.5">Tambahkan Kredensial Lokasi</a>
              </div>
            </div>
          </div>
        </div>
